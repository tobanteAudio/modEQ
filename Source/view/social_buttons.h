...
public:
    SocialButtons()
    {
        ...
        b->addListener(this);
        auto fbLogo = ImageCache::getFromMemory(
        ...
        b->addListener(this);
        auto githubLogo
            = ImageCache::getFromMemory(TobanteAudioData::GitHublogo_png,
                                        TobanteAudioData::GitHublogo_pngSize);
        b->setImages(false, true, true, githubLogo, 1.0f,
                     Colours::transparentWhite, githubLogo, 0.7f,
                     Colours::transparentWhite, githubLogo, 0.7f,
                     Colours::transparentWhite);
